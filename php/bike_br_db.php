...
$value=$_POST['bike_brand'];
$query="SELECT *FROM bikes where brand_name = '$value'";
...
while ($res=mysql_fetch_array($result)) {
	# code...
	 ...
	 echo "<center><table border=2><tr><td>$res[1]</td><td>$res[2]</td><td>$res[3]</td><td>$res[4]</td><td>$res[5]</td><td>$res[6]</td><td>$res[7]</td><br></center>";
